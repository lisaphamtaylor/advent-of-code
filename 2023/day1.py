...
def sum_first_last(dataset):
    '''returns sum of first and last digit of each line in dataset'''
    # initializing sum
    sum = 0

    # iterating over each line of data
    for line in data:
        # checking if line is populated
        if line:
        ...
        # adding first and last digit of line_num to sum
        sum += int(line_num[0])*10+int(line_num[-1])
    print(sum)

sum_first_last(data) # sum was 54708
